#!/usr/bin/env python
# -*- coding: utf-8 -*-
from tkinter import Tk,Label,Button,filedialog,Entry,StringVar,messagebox,PhotoImage
import glob
import pyaudio
import os
import wave
...
img2 = PhotoImage(file="record.png")
img3 = PhotoImage(file="stop.png")
btnIniciar=Button(ventana,fg='blue',width=116, image=img2,justify='center', command=iniciar)
btnIniciar.place(x=122,y=71)
btnParar=Button(ventana, fg='blue', width=116, image=img3,justify='center', command=parar)
btnParar.place(x=244,y=71)
btnDir=Button(ventana, text="Carpeta",width=16,command=direc)
btnDir.place(x=0,y=71)
btnAbrir=Button(ventana, image=img,justify='center',width=116,command=abrir)
